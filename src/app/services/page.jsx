...
export default function ServicesGrid3D() {
  return (
    <section className="relative py-14 md:py-20 text-white overflow-hidden bg-[#020617]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        {/* Header */}
        <h2 className="text-4xl md:text-6xl font-extrabold text-center mb-4 md:mb-6 bg-gradient-to-r from-blue-200 via-blue-400 to-blue-600 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(59,130,246,0.15)]">
          Our Premium Services
        </h2>

        <p className="text-center text-blue-100/80 max-w-2xl mx-auto mb-14 md:mb-16 leading-relaxed text-base md:text-lg">
            ...
            <Link key={service.slug} href={`/services/${service.slug}`} className="block h-full">
              ...
              >
                ...
                >
                  ...
                  <p className="text-sm md:text-base font-medium mb-3 md:mb-4 text-blue-300/90">
                    {service.subtitle}
                  </p>
