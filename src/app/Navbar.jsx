...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 bg-gray-100/90 backdrop-blur-md text-gray-900 border-b border-gray-300 shadow-sm">
            ...
            {isOpen && (
                <div className="md:hidden bg-white/95 backdrop-blur-lg border-t border-slate-200 px-6 py-6 space-y-6">
                    {/* SERVICES DROPDOWN */}
                    <div className="space-y-2">
                        ...
                        {mobileOpen.services && (
                            <div className="bg-gray-50 rounded-xl shadow-sm border border-gray-200 p-3 space-y-2">
                                {serviceGroups.map(
