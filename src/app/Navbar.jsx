      ...
      {isOpen && (
        <div className="md:hidden bg-white/95 backdrop-blur-lg border-t border-slate-200 px-6 py-6 space-y-8">
          ...
          <div className="space-y-3">
            <div className="font-semibold text-slate-900 text-lg">Services</div>
            <div className="bg-gray-50 rounded-xl shadow-sm border border-gray-200 p-3">
              {serviceGroups.map(({ slug, title, icon: Icon }) => (
                <Link
                  key={slug}
                  href={`/services/${slug}`}
          ...
          {/* Products */}
          <div className="space-y-3">
            <div className="font-semibold text-slate-900 text-lg">Products</div>
            <div className="bg-gray-50 rounded-xl shadow-sm border border-gray-200 p-3">
              {productGroups.map(({ slug, title, icon: Icon }) => (
                <Link
                  key={slug}
                  href={`/products/${slug}`}
                  onClick={() => setIsOpen(false)}
